...
# Create a function for scraping the news title and paragraph 
...
# Create a function for scraping the featured image
...
# Create a function for scraping Mars Facts
def mars_facts():
   try:
...
# Create a function for scraping Mars hemisphere images and titles
def mars_hemispheres(browser):
   ...
   for x in range (0,4):
      ...
      hemisphere_image_urls.append({'image_url':img_full_url, 'title': title_var})
